...
def _authenticate():
    if PASSWORDLESS_AUTHENTICATION:
        ...
        SUBSCRIPTION_KEY = os.getenv("SUBSCRIPTION_KEY", 'e7728fa2f8df41ec943223b90762f8cd')
...
def submit_synthesis(job_id: str):
    ...
    payload = {
        ...
        "avatarConfig": 
        {
            ...
            "talkingAvatarCharacter": 'Binaka-half',  # talking avatar character
            ...
            "useBuiltInVoice": True,  # Enable built-in voice for avatar
